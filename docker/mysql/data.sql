...
--
INSERT INTO `oamarelinho`.`country` (`id`, `name`, `name_pt-br`, `initials`, `bacen`) VALUES
...
--
INSERT INTO `oamarelinho`.`state` (`id`, `name`, `uf`, `ibge`, `country_id`, `ddd`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
--
INSERT INTO `oamarelinho`.`city` (`id`, `name`, `state_id`, `ibge`) VALUES
...
--
INSERT INTO `oamarelinho`.`company` (`id`, `name`, `city_id`) VALUES
(1, 'Sanar', 616),
(2, 'IFood', 3658),
(3, '123 Milhas', 3658),
(4, 'Magazine Luíza', 5270),
(5, 'Americanas', 5270);

--
-- Inserindo dados na tabela "empresa"
--
INSERT INTO `oamarelinho`.`job` (`id`, `title`, `description`, `created_at`, `updated_at`, `company_id`, `city_id`) VALUES
(1, 'ESTÁGIO EM ADMINISTRAÇÃO', 'Formação prevista entre dezembro/2023 e dezembro/2024 nos cursos de Administração de Empresas, Tecnologia em Gestão de Processos, Gestão de Negócios e Gestão de RH. Oferecemos bolsa-auxilio no valor de R$ 1.300,00, vale-transporte, vale-alimentação, assistência medica e odontológica. Horário das 9h às 16h.', '2022-06-01', '2022-06-01', 1, 616),
(2, 'OPERADOR (A) DE TELEMARKETING', 'Requisitos do cargo. Ser ativo em vendas presenciais na zona leste salário mais premiação diária com ou sem experiência. Escolaridade: Ensino médio (2º grau).Experiência.Ser ativo em vendas. Beneficios: Vale transporte já com integração.', '2022-01-010', '2022-01-013', 1, 616),
(3, 'MOTOBOY', 'Mais informações sobre a vaga de emprego: Requisitos do cargo - Para trabalhar em Embu das Artes, Taboão da Serra e Itapecerica da Serra (sede em Embu das Artes); - Regime de contratação: Prestador de serviços(MEI); Escolaridade: Ensino fundamental (1º grau) Competências - Entrega de pequenas encomendas porta a porta; - Ótimos Ganhos Quinzenais de até 3.000,00; - Roteiro todos os dias e centralizados; - Necessário Celular Android(com internet), Cnh, Moto Própria(doc. em dias), Baú ou mochilão. - Comprometimento e responsabilidade; Outros requisitos: - INTERESSADOS ENCAMINHAR CURRÍCULO DIRETAMENTE EM NOSSO WHATSAPP: 11 98758‑0674. Área de atuação: Outras', '2022-10-10', '2022-10-18', 1, 616),
(4, 'ATENDENTES', 'Supermercado admite, ambos os sexos, com ou sem prática. Atendente', '2022-02-22', '2022-02-22', 2, 3658),
(5, 'AUXILIAR DE COZINHA / ATENDENTE DE FAST-FOOD', 'Hamburgueria BREAK LAB BURGER contrata: M/F. Trabalhar nas regiões do Jardim Taquaral e Pinheiros, em São Paulo. Disponibilidade para vagas diurnas ou noturnas. Contratação CLT, vale-transporte, vale-refeição e seguro de vida. Atendente', '2021-12-31', '2021-12-31', 2, 3658),
(6, 'JOVEM APRENDIZ', 'De 16 a 21 anos, somente estudantes 2° grau ou técnico. Escritório de telefonia Claro. De segunda a sexta-feira, das 9h às 16h. Bolsa estudo ( fixo), vale-transporte e bonificação. Vila Maria, zona norte.', '2022-07-07', '2022-07-07', 2, 3658),
(7, 'ESTÁGIO EM CIÊNCIAS CONTÁBEIS', 'Formação entre dezembro/2023 e dezembro/2025 no curso de Ciências Contábeis. Oferecemos bolsa-auxílio no valor de R$ 1.732,50, vale-transporte e vale-refeição. Horário das 10h às 17h.', '2022-05-20', '2022-05-25', 3, 5270),
(8, 'VENDEDORES(AS)', 'Urgente! Freelance! Para início imediato. Trabalhar em loja nos finais de semana. Podem ser aposentados(as).', '2022-09-01', '2022-10-04', 3, 5270),
(9, 'ESTÁGIO EM ENGENHARIA ELÉTRICA', 'Cursando quarto ano no curso de Engenharia Elétrica. Oferecemos bolsa-auxílio no valor de R$ 1.500,00, vale-transporte, vale-refeição e assistência médica. Horário da 9h às 16h.', '2022-09-30', '2022-09-30', 3, 5270),
(10, 'VENDEDORES(AS) EXTERNOS(AS)', 'Vender no comércio de porta a porta, 50% comissão, ganhos médios diários: R$224,25. Produto fácil para vender', '2022-03-18', '2022-03-18', 3, 5270);
